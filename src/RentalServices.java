...
public class RentalServices {
	...
	public RentalServices() {
		cameraDetails.addCameraIntoList(new CameraPojo("Fujifilm", "D 780", 2000.0));
	    cameraDetails.addCameraIntoList(new CameraPojo("Sony ", "ILCE-6400", 1000.0));
	    cameraDetails.addCameraIntoList(new CameraPojo("Canon", "Z30", 3000.0));
	    cameraDetails.addCameraIntoList(new CameraPojo("Panasonic", "Lumix G7", 1250.0));
	    cameraDetails.addCameraIntoList(new CameraPojo("Canon", "EOS 3000D", 2500.0));
	    cameraDetails.addCameraIntoList(new CameraPojo("Nikon", "Nikon D5", 3500.0));
